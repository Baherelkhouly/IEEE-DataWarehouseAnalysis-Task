...
-- DIMENSIONS EXPLORATION
  -- LIST ALL COUNTRIES OUR CUSTOMERS COME FROM
...
-- MEASURES EXPLORATION  
  ...
  -- FULL KEY METRICS REPORT
    SELECT 'Total Sales' AS measurement_name, SUM(sales_amount) AS measurement_value FROM gold.fact_sales
	UNION ALL
	SELECT 'Total Quantity', SUM(quantity) FROM gold.fact_sales
	UNION ALL
	SELECT 'Averrage Price', AVG(price) FROM gold.fact_sales
	UNION ALL
	SELECT 'Orders Number', COUNT(DISTINCT order_number) FROM gold.fact_sales
	UNION ALL
    SELECT 'Products Number', COUNT(DISTINCT product_key) FROM gold.fact_sales
	UNION ALL
    SELECT 'Customers Number', COUNT(customer_id) FROM gold.dim_customers 
...
-- MAGNITUDE ANALYSIS
  ...
  SELECT category, AVG(cost) AS total_costs FROM gold.dim_products GROUP BY category ORDER BY total_costs DESC
